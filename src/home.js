...
function Home() {
  ...
  const cartonize = async () => {
    ...
    axios({
      method: "POST",
      url: "http://192.168.2.114:7000/Api/upload/",
      data: ImageFormData,
    ...
    if (Id !== undefined && Id !== null) {
      ...
      try {
        const response = await axios.post(
          "http://192.168.2.114:7000/Api/download/",
          body,
          {
  ...
  const staticUrl = "http://192.168.2.114:7000";
    ...
    <>
      <div style={{ padding: "2rem" }}>
        <div style={{ textAlign: "center" }}>
          <h2
            style={{ fontSize: "3rem", paddingBottom: "1rem", color: "white" }}
          >
        ...
        <div style={{ textAlign: "center" }}>
          <h4 style={{ fontSize: "18px", padding: "2rem 1rem 0rem 0rem", color: "greenyellow" }}>
            👉 Presented as part of the Demo Project @ Colan Infotech
          </h4>
          <h4 style={{ fontSize: "18px", color: "greenyellow" }}>
            👷 Project Authors: Ashika
          </h4>
        </div>
      </div>
    </>
